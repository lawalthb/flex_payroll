                        ...
                        <div id="page-main-content" class="">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="border-top td-relationship p-2">
                                        <div class="row align-items-center">
                                            <div class="col">
                                    ...
                                    <div class="border-top td-otherinfo p-2">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="text-muted"> Otherinfo</div>
                                                <div class="font-weight-bold">
                                    ...
                                    <div class="border-top td-hardcopy p-2">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="text-muted"> Hardcopy</div>
                                                <div class="font-weight-bold">
