            ...
            <div class="row ">
                <div class="col-md-12 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div id="positions-list-records">
                            <div class="row">
                                <div class="col">
                                    <div id="page-main-content" class="table-responsive">
                                        <?php Html::page_bread_crumb("/positions/", $field_name, $field_value); ?>
                                        <table class="table table-hover table-striped table-sm text-left">
                                            <thead class="table-header ">
                                                <tr>
                                                    ...
                                                    <th class="td-department_id <?php echo (get_value('orderby') == 'department_id' ? 'sortedby' : null); ?>" >
                                                    <?php Html :: get_field_order_link('department_id', "Department", ''); ?>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <?php
                                            ...
                                            <tbody class="page-data">
                                                ...
                                                <tr>
                                                    <!--PageComponentStart-->
                                                    <td class="td-id">
                                                        <a href="<?php print_link("positions/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                                    </td>
                                                    <td class="td-name">
                                                        <?php echo  $data['name'] ; ?>
                                                    </td>
