            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <!--[form-start]-->
                        <form id="positions-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('positions.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-name-holder" class=" ">
                                                <input id="ctrl-name"  value="<?php echo get_value('name', "NULL") ?>" type="text" placeholder="Enter Name"  name="name"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
