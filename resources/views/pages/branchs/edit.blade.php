                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("branchs/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-state-holder" class=" ">
                                                    <input id="ctrl-state"  value="<?php  echo $data['state']; ?>" type="text" placeholder="Enter State"  required="" name="state"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
