            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class="card-4 page-content" >
                        <!--[form-start]-->
                        <form id="branchs-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('branchs.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-state-holder" class=" ">
                                                <input id="ctrl-state"  value="<?php echo get_value('state') ?>" type="text" placeholder="Enter State"  required="" name="state"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-contact_person-holder" class=" ">
                                                <input id="ctrl-contact_person"  value="<?php echo get_value('contact_person', "NULL") ?>" type="text" placeholder="Enter Contact Person"  name="contact_person"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
